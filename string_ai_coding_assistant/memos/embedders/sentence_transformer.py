...
from string_ai_coding_assistant.memos.configs.embedder import SenTranEmbedderConfig
...
class SenTranEmbedder(BaseEmbedder):
    ...
    def embed(self, texts: list[str]) -> list[list[float]]:
        ...
        # Ensure proper conversion from numpy scalars to Python float objects
        # This prevents "Unsupported vector type" errors in Qdrant
        return [[float(val) for val in embedding] for embedding in embeddings.tolist()]
